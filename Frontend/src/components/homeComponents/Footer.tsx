...
const Footer: React.FC = () => {
  ...
  // Go to section after clicking item from menu in footer
  ...
  return (
    <div className={styles.Container}>
        ...
        <div className={styles.right}>
          ...
          <div className={styles.ContactItem}>
            <a href='/' target="_blank" rel="noreferrer">
              <LinkedInIcon style={{ marginRight: '5px', color: '#2196f3' }} />Khaled Hamouda
            </a>
          </div>
          <div className={styles.ContactItem}>
            <a href='/' target="_blank" rel="noreferrer">
              <LinkedInIcon style={{ marginRight: '5px', color: '#2196f3' }} /> Ahmed Fadl
            </a>
          </div>
          <div className={styles.ContactItem}>
            <a href='/' target="_blank" rel="noreferrer">
              <LinkedInIcon style={{ marginRight: '5px', color: '#2196f3' }} /> Khaled Hamdy
            </a>
          </div>
          <div className={styles.ContactItem}>
            <a href='/' target="_blank" rel="noreferrer">
              <LinkedInIcon style={{ marginRight: '5px', color: '#2196f3' }} /> Motaz
            </a>
          </div>
        </div>
      </div>
      <div className={styles.lowerFotter}>
        <div className={styles.left}>
          <Link to={currentLocation}>ReadHub </Link> - Project implemented using Reactjs Nodejs Express MongoDB
        </div>
      </div>
    </div>
  );
